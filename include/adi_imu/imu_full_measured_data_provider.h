...
#ifndef ADI_IMU__IMU_FULL_MEASURED_DATA_PROVIDER_H_
#define ADI_IMU__IMU_FULL_MEASURED_DATA_PROVIDER_H_
...
public:
   ...
   */
  bool getData(adi_imu::msg::ImuFullMeasuredData & message) override;
...
#endif  // ADI_IMU__IMU_FULL_MEASURED_DATA_PROVIDER_H_
