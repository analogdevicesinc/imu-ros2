...
#ifndef ADI_IMU__ACCELGYROTEMP_ROS_PUBLISHER_INTERFACE_H_
#define ADI_IMU__ACCELGYROTEMP_ROS_PUBLISHER_INTERFACE_H_
...
#endif  // ADI_IMU__ACCELGYROTEMP_ROS_PUBLISHER_INTERFACE_H_
