...
std::string ADISRegisterMap::getDeviceFamily() const
{
  return m_device_family;
}
std::string ADISRegisterMap::getDeviceName() const
{
  return m_device_name;
}
adis_device_id ADISRegisterMap::getDeviceID() const
{
  return m_device_id;
}
...
void ADISRegisterMap::set(ADISRegister reg, uint32_t value)
{
  m_register_map[reg] = value;
}
...
void ADISRegisterMap::computeBitMasks()
{
  ...
  {
    set(ADISRegister::GYRO_MEAS_RANG, 3 << get(ADISRegister::GYRO_MEAS_RANG_POS));  // 3 was first seen value
  }
  ...
  {
    set(ADISRegister::X_AXIS_GYRO_BIAS_CORR_EN, 1 << get(ADISRegister::X_AXIS_GYRO_BIAS_CORR_EN_POS));
  }
  if (has(ADISRegister::Y_AXIS_GYRO_BIAS_CORR_EN_POS))
  {
    set(ADISRegister::Y_AXIS_GYRO_BIAS_CORR_EN, 1 << get(ADISRegister::Y_AXIS_GYRO_BIAS_CORR_EN_POS));
  }
  if (has(ADISRegister::Z_AXIS_GYRO_BIAS_CORR_EN_POS))
  {
    set(ADISRegister::Z_AXIS_GYRO_BIAS_CORR_EN, 1 << get(ADISRegister::Z_AXIS_GYRO_BIAS_CORR_EN_POS));
  }

  if (has(ADISRegister::X_AXIS_ACCEL_BIAS_CORR_EN_POS))
  {
    set(ADISRegister::X_AXIS_ACCEL_BIAS_CORR_EN, 1 << get(ADISRegister::X_AXIS_ACCEL_BIAS_CORR_EN_POS));
  }
  if (has(ADISRegister::Y_AXIS_ACCEL_BIAS_CORR_EN_POS))
  {
    set(ADISRegister::Y_AXIS_ACCEL_BIAS_CORR_EN, 1 << get(ADISRegister::Y_AXIS_ACCEL_BIAS_CORR_EN_POS));
  }
  if (has(ADISRegister::Z_AXIS_ACCEL_BIAS_CORR_EN_POS))
  {
    set(ADISRegister::Z_AXIS_ACCEL_BIAS_CORR_EN, 1 << get(ADISRegister::Z_AXIS_ACCEL_BIAS_CORR_EN_POS));
  }
  ...
  if (has(ADISRegister::PAGE_ID_VAL) && has(ADISRegister::PT_OF_PERC_PAGE_ID) &&
  ...
  if (has(ADISRegister::PAGE_ID_VAL) && has(ADISRegister::NULL_CNFG_PAGE_ID) &&
  ...
  {
    set(ADISRegister::FACTORY_CALIBRATION_RESTORE, 1 << get(ADISRegister::FACTORY_CALIBRATION_RESTORE_POS));
  }
  if (has(ADISRegister::SOFTWARE_RESET_CMD_POS))
  {
    set(ADISRegister::SOFTWARE_RESET_CMD, 1 << get(ADISRegister::SOFTWARE_RESET_CMD_POS));
  }
  if (has(ADISRegister::PAGE_ID_VAL) && has(ADISRegister::DIAG_STAT_PAGE_ID) &&
  ...
  if (has(ADISRegister::PAGE_ID_VAL) && has(ADISRegister::DIAG_STS_PAGE_ID) &&
  ...
  if (has(ADISRegister::PAGE_ID_VAL) && has(ADISRegister::RANG_MDL_PAGE_ID) &&
